...
exports.getInvoices = async (req, res) => {
  try {
    const { type, site, paymentStatus, startDate, endDate, page = 1, limit = 20, financialYear, search } = req.query;
    ...
    if (search) {
      ...
      filter.$or = [{ invoiceNumber: q }, { 'customer.name': q }, { 'customer.company': q }, { 'supplier.name': q }];
    }
